...
urlpatterns = [
    ...
    url(r'^(?P<gallery_id>[0-9]+)/comment_gallery/$', views.comment_gallery, name='comment_gallery'),
    url(r'^(?P<gallery_id>[0-9]+)/delete_comment_gallery/(?P<comment_id>[0-9]+)$', views.delete_comment_gallery, name='delete_comment_gallery'),
