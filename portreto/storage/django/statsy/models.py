...
class StatsyObject(models.Model):
    group = models.ForeignKey(
        ...
        related_name='statsy_object_list', verbose_name='group', on_delete=models.PROTECT
    )
    event = models.ForeignKey(
        'StatsyEvent', blank=True, null=True,
        related_name='statsy_object_list', verbose_name='event', on_delete=models.PROTECT
    )
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, blank=True, null=True,
        related_name='statsy_object_list', verbose_name='user', on_delete=models.PROTECT
    )
